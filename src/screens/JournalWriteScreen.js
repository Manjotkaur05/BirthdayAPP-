...
const styles = StyleSheet.create({
  ...
  heading: { color: theme.textPrimary, textAlign: "center", fontSize: 28, fontWeight: "800", marginBottom: 10 },
  ...
  primaryBtnText: { color: theme.textPrimary, textAlign: "center", fontWeight: "700" },
  ...
  deleteText: { color: theme.textPrimary, fontWeight: "800" },
  ...
  modalTitle: { color: theme.textPrimary, fontSize: 20, fontWeight: "800", marginBottom: 10 },
  modalActions: { flexDirection: "row", justifyContent: "space-between", gap: 10 },
  secondaryBtn: { backgroundColor: theme.lightPink, borderRadius: 10, paddingVertical: 12, paddingHorizontal: 18 },
  secondaryBtnText: { color: theme.textPrimary, fontWeight: "700" },
});
